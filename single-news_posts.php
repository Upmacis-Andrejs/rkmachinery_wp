			...
			<div class="row">
				<div class="slider-and-content-wrapper row">
					<div class="slider-wrapper float-left">
						...
						if( $images ): ?>
						    <ul class="lightslider cS-hidden" id="lightslider-1">
					...
					<div class="page-content-block float-right">
						...
						<div class="share-buttons flex">
							<?php if( have_posts() ): while( have_posts() ): the_post(); ?>
								...
								<div class="tweet">
									<a class="social-btn twitter-share-btn" href="https://twitter.com/intent/tweet?url=<?php echo urlencode(get_the_permalink()); ?>" data-show-count="true" target="_blank"><?php _e('Tweet', 'rkmachinery'); ?></a>
